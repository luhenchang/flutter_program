...
import 'package:flutter_program/fragment_five/view/FragmentXunJian.dart';
...
class XunJianPager extends StatefulWidget {
  List<FiveBaseBean> dataAlready;

  XunJianPager(this.dataAlready);

  @override
  _XunJianPagerState createState() => new _XunJianPagerState(dataAlready);
}

class _XunJianPagerState extends State<XunJianPager> {
  List<FiveBaseBean> dataAlready = new List();
  double toalTime;

  _XunJianPagerState(this.dataAlready);
              ...
              onTap: () {
                ...
                Navigator.of(context).push(new PageRouteBuilder(
                  pageBuilder: (BuildContext context, _, __) {
                     return new FragmentXunJian(dataAlready[index]);
                  },
                ));
              },
              child: Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: Text(
                              dataAlready[index].routingInspectionNumber,
